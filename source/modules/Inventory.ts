...
export default class Inventory {
    ...
    getValue(steamid64: string) {
        return this.backpacktf.__request(
            'get',
            `/inventory/${steamid64}/values`
        ) as Promise<BackpackTF.Inventory.Values>;
    }
    ...
    getStatus(steamid64: string) {
        return this.backpacktf.__request(
            'get',
            `/inventory/${steamid64}/status`
        ) as Promise<BackpackTF.Inventory.Status>;
    }
